...
map('n', '<C-J>', function() harpoon:list():select(4) end, opts("Harpoon select 1"))
map('n', '<C-K>', function() harpoon:list():select(5) end, opts("Harpoon select 2"))
map('n', '<C-L>', function() harpoon:list():select(6) end, opts("Harpoon select 3"))
